...
group_welcome = string.gsub(group_welcome, '{‰«„ ê—ÊÂ}', msg.to.title)
group_welcome = string.gsub(group_welcome, '{‰«„ «Ê·}', ""..(msg.action.user.first_name or '').."")
 group_welcome = string.gsub(group_welcome, '{‰«„ ¬Œ—}', ""..(msg.action.user.last_name or '').."")
  group_welcome = string.gsub(group_welcome, '{‰«„ ò«—»—Ì}', "@"..(msg.action.user.username or '').."")
  group_welcome = string.gsub(group_welcome, '{”«⁄  ›«—”Ì}', ""..(jdat.FAtime).."")
  group_welcome = string.gsub(group_welcome, '{ «—ÌŒ ›«—”Ì}', ""..(jdat.FAdate).."")
